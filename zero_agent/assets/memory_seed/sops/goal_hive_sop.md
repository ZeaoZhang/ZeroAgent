...
启动 worker：`start /b zero-agent --reflect <CodeRoot>/zero_agent/reflect/agent_team_worker.py --reflect-arg base_url=http://127.0.0.1:<PORT> --reflect-arg board_key=<BOARD_KEY> --reflect-arg name=hive-worker-1`。
