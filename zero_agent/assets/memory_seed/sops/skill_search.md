...
```python
from zero_agent.utils.skill_search import search
...
```bash
python -m zero_agent.utils.skill_search "python testing"
python -m zero_agent.utils.skill_search "docker deployment" --category devops --top 5
python -m zero_agent.utils.skill_search "git" --json
python -m zero_agent.utils.skill_search --stats
python -m zero_agent.utils.skill_search --env
```
