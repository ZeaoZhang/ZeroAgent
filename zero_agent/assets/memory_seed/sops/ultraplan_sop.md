...
Allowed pre-launch work: record objective/constraints, confirm cwd is the agent's workspace directory, write the minimal script.
...
import os, sys
sys.path.append("..")
from zero_agent.assets.ga_ultraplan import plan, phase, parallel, mapchain
