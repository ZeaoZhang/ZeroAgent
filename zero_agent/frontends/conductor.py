...
from zero_agent.frontends.za_adapter import AgentRunner, create_agent as create_zero_agent_runner


def create_agent() -> AgentRunner:
    return create_zero_agent_runner()
...
def start_agent_runner(agent: AgentRunner, name: str):
