...
# Must run BEFORE importing ZeroAgent — it reconfigures stdout at import time,
...
# prints from zero_agent don't pollute the ACP channel.
...
class _StdoutToStderrRouter(io.TextIOBase):
    """Redirect text-mode stdout to stderr so zero_agent prints don't leak."""
